...
The operator sizeof... is used for counting the number of template
arguments.
...
#+BEGIN_SRC cpp 
  ...
  void countParameters(Params ... params){
       std::cout << "Number of parameters to = " << sizeof...(params) << "\n";
  }
#+END_SRC
