...
#+BEGIN_SRC sh 
  ...
  [2] Types are equal
#+END_SRC
*** Template Specilization for Metafunctions 

Metafunction is a template metaprogramming technique for type
instrospection, type manipulation and type computation. This idiom
...
Example in file: [[file:src/template-metafunction.cpp][file:src/template-metafunction.cpp]]
