...
Features:
  ...
  + Standard building system and package manager: [[https://doc.rust-lang.org/cargo/index.html][cargo]]
  + Endorsed by many companies such as: Microsoft, Mozzila, Apple and so on. 
...
** Scientific and numerical computing
   ...
   * [[https://en.wikipedia.org/wiki/Julia_%2528programming_language%2529][Julia Language]] (2012)
     ...
     + Disadvantages:
       ...
       + Less efficient. Despite the performance, Julia still uses
         more CPU time and memory resources than C++, which is still
         one of the best ways to take full advantage of every penny
