...
|                           |                                                                                                  |
| *Technical Standards*       |                                                                                                  |
| _ISO/IEC 14882_             | C++ Programming Language Standard and Specification used by most compiler vendors.               |
...
| Mega Byte (MB)  | 1024 x 1024 x 8 | -        | 1024      | 1             | -            |
| Giga Bytes (GB) | -               | -        | -         | 1024          | -            |
| Penta Bytes     | -               | -        |           | -             | 1024         |
|-----------------+-----------------+----------+-----------+---------------+--------------|
...
|--------+-----+--------------------------------+------------------|
| N bits | Min | Max                            | Number of values |
|--------+-----+--------------------------------+------------------|
|      8 |   0 | 2^8 - 1  = 255                 |              256 |
|     10 |   0 | 2^10 - 1 = 1023                |             1024 |
|     12 |   0 | 2^12 - 1 = 4095                |             4096 |
|     16 |   0 | 2^15 - 1 = 65535               |            65536 |
