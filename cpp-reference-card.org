...
** General C++ Terminology and Concepts 
 ...
 + *Pointers*
   ...
   - _Pointer "this"_
     ...
     + Use cases:
       + Getting a point to current object.
       + Ambiguity resolution, for instance, if a function has a
         ...
         _this->count = count;_
       + Make it explicit that a class method is being invoked, for
         instance, this->method(arg0, arg1, arg2) is more explicit
         than method(arg0, arg1, arg2) which could be an external
         function instead of a class' member function.
