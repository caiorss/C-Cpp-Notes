...
*** Example - Eliminating Virtual Member Function 
...
Videos: 
 ...
 + 
*** Example - Generating operator free functions 
...
Note: It is not a design pattern, but a for methodology for
developing cross platform applications in C++.
   ...
   5. [[https://jenkins.io/][Jenkins]] CI for simultaneous and automate cross-platform compilation
      * Continuous Integration server can be used for
        ...
        or platforms. This approach allows aromatic simultaneous
