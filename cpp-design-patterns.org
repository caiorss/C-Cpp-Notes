...
Note: It is not a design pattern, but a useful for methodology for
designing cross platform applications in C++.
 ...
 2. Isolate platform-specific code from non-platform specific code
    using macros, conditional compilation or separate classes.
