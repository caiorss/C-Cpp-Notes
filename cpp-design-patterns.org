...
Visitor with C++17 - std::variant 
 ...
 + [[https://www.heise.de/developer/artikel/C-17-hat-einen-Visitor-3700274.html][C++17
   hat einen Visitor | heise Developer]] (In German)
*** Example: Basic Visitor 

File: [[file:src/design-patterns/visitor1.cpp][file:src/design-patterns/visitor1.cpp]]
...
#+BEGIN_SRC txt 
  ...
  Perimiter of shape 1 = 56.547
  Perimiter of shape 2 = 16
  Perimiter of shape 3 = -100
#+END_SRC
