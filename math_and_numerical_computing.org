...
number engine and a probability distribution. 
 ...
 + *seed generator:* An object that yields new seed random whenever
   it is invoked. Its purpose is to initialize the random engine.    
...
*** Example - Normally Distribution Randoms 
