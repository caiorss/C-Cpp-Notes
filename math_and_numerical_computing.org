...
|-------------+------+---+----+-----+-------+----------------------------------------|
| C++ Type    | Bits | S |  E |   M |     B | Description                            |
|-------------+------+---+----+-----+-------+----------------------------------------|
| float       |   32 | 1 |  8 |  23 |   127 | IEE754 single precision float point    |
| double      |   64 | 1 | 11 |  52 |  1023 | IEE754 double precision float point    |
| long double |  128 | 1 | 15 | 112 | 32767 | IEE754 quadruple precision float point |
|-------------+------+---+----+-----+-------+----------------------------------------|

 + S => Sign bits => 0 for positive numbers and 1 for negative numbers.
 + E => Exponent bits
 + M => Mantiassa Bits (aka Fraction)
 + B => Exponent Bias
