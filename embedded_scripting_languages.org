...
and calling Java objects at runtime without any recompilation. 

File: _sexpr.kt_ (About: 2130 lines of code)
...
Loading a script that creates a Java Swing GUI application:
