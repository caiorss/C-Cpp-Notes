...
+ *GNU Scientific Library - GSL* - "The library provides a wide range
  ...
  + Repository:
** Linux CRT - Linux C-Runtime and C++-Runtime Libraries 
...
** Parsers for standardized file formats 
...
** QT Widgets and QtQuick/QML Libraries and Applications         :qt:qml:gui:
 ...
 *Open Source - Operating Systems for IOT - Internet Of Things*
