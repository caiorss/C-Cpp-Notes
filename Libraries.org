...
Selection of C++ template libraries which allow general purpose
computing on GPUs using C++11 to C++17 without any extension language
such as CUDA, OpenACC, OpenCL and so on.

  + *Boost.Compute* [VENDOR NEUTRAL]
    + Site: http://boostorg.github.io/compute/
...
*** Parallel Computing - MPI (Distributed computing, clusters)
