 ...
 *Common Debuggers*
 ...
 + [[https://www.hex-rays.com/products/ida/debugger/index.shtml][IDA]] - Interactive Dissassembler and debugger specialized for
   reverse engineering. IDA is widely used for reverse engineering
   malwares.

 + [[http://www.valgrind.org/][Valgrind]] (Unix-like operating systems) - No exactly a debugger,
   however it is useful for detecting memory leaks, profiling and so
   on. 
