...
Source:  [[file:src/windows/client-socket-shell1.cpp][file:src/windows/client-socket-shell1.cpp]]
...
STEP 4 - Type any commands from server side and they will be sent back
to the client. 
