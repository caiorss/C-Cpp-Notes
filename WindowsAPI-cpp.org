...
Qt Framework (_wxQt_) and Motiff (obsolete) _wxMotiff_. In addition to
...
Advatanges: 
  ...
  + Closed-source and commercial applications can statically link
...
Drawbacks: 
  ...
  + Poor documentation, not as good as Qt documentation.
  ...
  + Unlike Qt, this framework don't support embedded plaforms 
